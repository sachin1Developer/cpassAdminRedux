...
function AddMobileGroup() {
    ...
    return (
        <Container>
            <div className=''>
                <b>
                    <h3 className='pvmHeading text-slate-800'>Add Mobile Group ✨
                        <div className='d-flex align-items-center '>
                            <Link to={{ pathname: '/groupManagement/groupManager', state: '0' }} style={{ textDecoration: 'none' }}>
