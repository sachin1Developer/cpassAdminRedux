...
function MobileGroup() {
    ...
    return (
        <Container>
            <div className=''>
                <b>
                    <h3 className='pvmHeading text-slate-800'>View Mobile Group ✨
                        <div className='d-flex align-items-center '>
                            <Link to='/groupManagement/groupManager/addMobileGroup' style={{ textDecoration: 'none' }}>
                                <Button type="submit" className="btnBack mb-3 d-flex align-items-center"  ><AddIcon />Add Mobile Group</Button>
                            </Link>
                        </div>
                    </h3>
                </b>
            ...
            <div>
                <TableContainer style={{ backgroundColor: '', width: '900px' }} >
                    <Table aria-label="simple table">
                        ...
                        {mobileGroupList.map((mobileList, index) => (
                            <ViewMobileGroupList
                                key={index}
                                list={mobileList}
...
const ViewMobileGroupList = ({ list, deleteRange }) => {
