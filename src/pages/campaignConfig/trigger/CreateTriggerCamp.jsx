    ...
    return (
        <div className='d-flex mb-4'>
            <div className='container-fluid my-2'>
                <div className="mx-4">
                    <b>
                        <h3 className='pvmHeading text-slate-800'>Create Trigger Campaign ✨
                            <div className='my-2'>
                                                    ...
                                                    <TableCell align="left" style={{ fontWeight: 'bolder', color: '' }}>
                                                        <div className="col-auto">
                                                            <select className="form-select border-secondary" id="country"  >
                                                                ...
                                                                {/* <option value="Reclycle">Reclycle</option> */}
                                                            </select>
                                                        </div>
                                                    </TableCell>
                                                </TableRow>
...
export default CreateTriggerCamp;