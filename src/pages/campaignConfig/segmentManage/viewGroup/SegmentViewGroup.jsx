...
import SegmentMobileGroup from './SegmentMobileGroup';
import SegmentMediaGroup from './SegmentMediaGroup';
...
function SegmentViewGroup() {
    ...
    return (
        <Container>
            <div>
                <b>
                    <h3 className='pvmHeading text-slate-800'>Segment View Group ✨
                    </h3>
                </b>
            </div>
...
export default SegmentViewGroup;