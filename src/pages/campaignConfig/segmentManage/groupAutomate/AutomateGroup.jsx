...
import ModifyCheckGroup from './ModifyCheckGroup';
...
function AutomateGroup() {
    ...
    return (
        <Container>
            <div>
                <b>
                    <h3 className='pvmHeading text-slate-800'>Group Automate ✨
                    </h3>
                </b>
            </div>
                ...
                <Box sx={{ width: '100%' }}>
                    <Box sx={{ borderBottom: 1, borderColor: 'divider', fontWeight: '800' }}>
                        <Tabs value={tabsValue} onChange={handleTabs} aria-label="basic tabs example">
                            <Tab style={{ fontWeight: '700' }} label="Schedule Group" {...a11yProps(0)} />
                            <Tab style={{ fontWeight: '700' }} label="Check/Modify Group" {...a11yProps(1)} />
                        </Tabs>
                    </Box>
