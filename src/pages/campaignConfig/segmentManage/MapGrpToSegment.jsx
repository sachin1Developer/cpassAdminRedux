...
import { Button, Row, Tooltip, Input, Col } from "reactstrap";
    ...
    return (
        <div className='d-flex mb-2'>
            <div className='container-fluid '>
                <div className="mx-4">
                    <b>
                        <h3 className='pvmHeading text-slate-800'>Add/Map Group To Segment ✨
                            {/* <div className='my-2'>
                        ...
                        <Box sx={{ width: '100%' }}>
                            <Box sx={{ borderBottom: 1, borderColor: 'divider', fontWeight: '800' }}>
                                <Tabs value={tabsValue} onChange={handleTabs} aria-label="basic tabs example">
                                    <Tab style={{ fontWeight: '700' }} label="Add Group To Campaign" {...a11yProps(0)} />
                                    <Tab style={{ fontWeight: '700' }} label="Map Group To Campaign" {...a11yProps(1)} />
                                </Tabs>
                            </Box>
                                    ...
                                    <Table aria-label="simple table">
                                        <TableHead>
                                            ...
                                            <TableRow className='bodyColor'>
                                                ...
                                                <TableCell align="left" style={{ fontWeight: 'bolder', color: 'rgb(100,116,139)' }}>
                                                    <Input type="text" className=" border-secondary" placeholder="Group Name" />
                                                </TableCell>
                                            </TableRow>
                                            <TableRow className='bodyColor'>
                                                <TableCell align="left" style={{ fontWeight: 'bolder', color: 'rgb(100,116,139)' }}>Group Type : </TableCell>
                                                <TableCell align="left" style={{ fontWeight: 'bolder', color: 'rgb(100,116,139)' }}>
                                                    <select className="form-select border-secondary text-center" id="country"  >
...
export default MapGrpToSegment;